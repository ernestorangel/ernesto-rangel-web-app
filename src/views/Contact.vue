            ...
            >
                <Transition>
                    ...
                    >
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input 
                                ...
                                name="name" 
                                type="text" 
                                class="rounded-lg p-2 bg-[#171717] border border-[#454545] outline-[#00D957] font-extralight" 
                            />
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input 
                                ...
                                name="email" 
                                type="text"
                                class="rounded-lg p-2 bg-[#171717] border border-[#454545]" 
                            />
                        </div>
                        ...
                        <button type="submit" class="p-4 rounded-lg bg-[#00D957] hover:bg-[#159046]">
                            Enviar
                        </button>
                    </form>
                    ...
                    >
                        ...
                        Enviado!
                        <button @click="setReadyStatus" class="text-sm text-[#717171] hover:text-[#00D957]">
            ...
            <div class="w-full sm:w-1/3 flex flex-col gap-8">
                <section 
                    ...
                    :class="[
                        ...
                        'border border-[#454545] rounded-md'
                    ]"
                >
                    <span 
                        :class="[
...
.loader:after {
    background:
        radial-gradient(closest-side at 50% 12.5%,
            #00D957 96%, #0000) 50% 0/20% 80% repeat-y,
        radial-gradient(closest-side at 12.5% 50%,
            #00D957 96%, #0000) 0 50%/80% 20% repeat-x;
}
