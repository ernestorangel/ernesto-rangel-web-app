...
export const I18N = {
  en: {
    ...
    nav: { about: 'About', work: 'Work', stack: 'Stack', soon: 'Coming soon', contact: 'Contact' },
    ui: {
      ...
      heroAndFast: 'and',
      heroAdj3: 'fast.',
      subhead: 'Full-stack engineer based in São Paulo. Six years across healthcare, energy, and retail — building front-ends in Vue and Electron, back-ends in Node.',
      ...
      sectionExpHeadline: { pre: 'A few years building across', strong: 'healthcare, energy, and retail', post: '.' },
      sectionStack: 'Stack',
      sectionSoon: 'On the way',
      sectionSoonHeadline: { pre: 'A few things', strong: 'I\'m building', post: 'next.' },
      sectionContact: 'Contact',
      contactHeadline: { pre: 'Got something solid', post: 'to ', strong: 'build?' },
      contactBlurb: 'I\'m open to interesting full-stack work — particularly Vue, Electron, and Node-based systems. Email is the best way.',
      miniBased: 'Based in',
    ...
    experience: [
      {
        role: 'Front-end Developer', company: 'ConnectPlug',
        sector: 'Retail · Point-of-sale', period: 'Aug 2025 — Present',
        summary: 'Building a desktop POS for restaurants and retail with Vue and Electron.',
        bullets: [
      ...
      {
        role: 'Front-end Developer', company: 'Comerc Energia',
        sector: 'Energy', period: 'Aug 2024 — Jul 2025',
      ...
      {
        role: 'Full-stack Developer', company: 'Qualicorp',
        sector: 'Healthcare', period: 'Aug 2022 — Jul 2024',
        summary: 'Full-stack work in healthcare, modeling complex relationships in a graph database.',
        bullets: [
    ...
    skills: {
      ...
      'Front-end':    ['Vue.js (2 & 3)', 'Vuetify', 'Tailwind CSS', 'Electron', 'CSS / SASS'],
      'Back-end & DB': ['Node.js', 'Express', 'Restify', 'Java', 'MongoDB', 'Neo4j'],
      'Tooling':      ['Git', 'Docker', 'Scrum / Kanban'],
    },

    comingSoon: [
      { key: 'blog', title: 'Writing', tag: 'Blog',
        blurb: 'Notes on building software in JavaScript — patterns, mistakes, and small tools.' },
      { key: 'courses', title: 'Courses', tag: 'Courses',
        blurb: 'Long-form courses on Vue, Electron, and shipping desktop apps that hold up in production.' },
      { key: 'downloads', title: 'Downloads', tag: 'Software',
        blurb: 'A small collection of desktop tools and a SaaS in progress. Built quietly, released slowly.' },
    ],
  },
  ...
  pt: {
    ...
    nav: { about: 'Sobre', work: 'Experiência', stack: 'Stack', soon: 'Em breve', contact: 'Contato' },
    ui: {
      ...
      heroAndFast: 'e',
      heroAdj3: 'rápido.',
      subhead: 'Engenheiro full-stack em São Paulo. Seis anos entre saúde, energia e varejo — front-ends em Vue e Electron, back-ends em Node.',
      ...
      sectionExpHeadline: { pre: 'Alguns anos construindo em', strong: 'saúde, energia e varejo', post: '.' },
      sectionStack: 'Stack',
      sectionSoon: 'A caminho',
      sectionSoonHeadline: { pre: 'Algumas coisas', strong: 'que estou construindo', post: 'a seguir.' },
      sectionContact: 'Contato',
      contactHeadline: { pre: 'Tem algo de verdade', post: 'pra ', strong: 'construir?' },
      contactBlurb: 'Estou aberto a trabalhos full-stack interessantes — especialmente em Vue, Electron e sistemas com Node. E-mail é o melhor caminho.',
    ...
    experience: [
      {
        role: 'Desenvolvedor Front-end', company: 'ConnectPlug',
        sector: 'Varejo · Ponto de Venda', period: 'Ago 2025 — Atual',
        summary: 'Desenvolvimento de um PDV desktop para restaurantes e varejo com Vue e Electron.',
        bullets: [
      ...
      {
        role: 'Desenvolvedor Front-end', company: 'Comerc Energia',
        sector: 'Energia', period: 'Ago 2024 — Jul 2025',
        summary: 'Dashboards e ferramentas para o mercado de energia brasileiro.',
        bullets: [
      ...
      {
        role: 'Desenvolvedor Full-stack', company: 'Qualicorp',
        sector: 'Saúde', period: 'Ago 2022 — Jul 2024',
        summary: 'Trabalho full-stack em saúde, modelando relacionamentos complexos em banco de grafos.',
        bullets: [
    ...
    skills: {
      ...
      'Front-end':     ['Vue.js (2 e 3)', 'Vuetify', 'Tailwind CSS', 'Electron', 'CSS / SASS'],
      'Back-end e BD': ['Node.js', 'Express', 'Restify', 'Java', 'MongoDB', 'Neo4j'],
      'Ferramentas':   ['Git', 'Docker', 'Scrum / Kanban'],
    },

    comingSoon: [
      { key: 'blog', title: 'Escrita', tag: 'Blog',
        blurb: 'Anotações sobre construir software em JavaScript — padrões, erros e pequenas ferramentas.' },
      { key: 'courses', title: 'Cursos', tag: 'Cursos',
        blurb: 'Cursos aprofundados sobre Vue, Electron e como entregar apps desktop que se sustentam em produção.' },
      { key: 'downloads', title: 'Downloads', tag: 'Software',
        blurb: 'Uma pequena coleção de ferramentas desktop e um SaaS em desenvolvimento. Construído com calma, lançado aos poucos.' },
    ],
  },
}
